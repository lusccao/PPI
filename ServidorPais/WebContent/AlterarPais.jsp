            ...
            <form action="controller.do" method="post">
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        <label for="area">Populacao</label>
                        <input type="number" class="form-control" name="populacao" id="populacao" maxlength="15" placeholder="Populacao" value="${pais.populacao }">
                    </div>
